...
public class SeleniumEasyDemoHomePage 
{
	 ...
	 * @param :baseTest
	 */
	public SeleniumEasyDemoHomePage(BaseTest  baseTest) 
	{
	...
	{
		objBaseTest.getObjWrapperFunctions().navigateToHomePage();
	}
	/**
	 * Description:By locator
	 */
	By loc_SeleniumEasyHomePage = By.xpath("//a[text()='Demo Home']");
	public void verifySeleniumEasyHomePageIsDisplayed() 
	{
		Assert.assertTrue(objBaseTest.getObjWrapperFunctions().checkIfElementIsDisplayed(loc_SeleniumEasyHomePage));
